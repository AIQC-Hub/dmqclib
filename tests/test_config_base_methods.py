...
class TestBaseConfigTargets(unittest.TestCase):
    ...
    def test_target_file_names(self):
        ...
        target_file_names = ds.get_target_file_names("select", "{target_name}_features.parquet")

        self.assertEqual(target_file_names["temp"], "/path/to/select_1/nrt_bo_001/select_folder_1/temp_features.parquet")
        self.assertEqual(target_file_names["psal"], "/path/to/select_1/nrt_bo_001/select_folder_1/psal_features.parquet")
        self.assertEqual(target_file_names["pres"], "/path/to/select_1/nrt_bo_001/select_folder_1/pres_features.parquet")
