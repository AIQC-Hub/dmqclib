...
class TestSelectDataSetA(unittest.TestCase):
    ...
    def test_init_valid_dataset_name(self):
        ...
        ds = SelectDataSetA("NRT_BO_001", config_file=str(self.config_file_path))
    ...
    def test_init_invalid_dataset_name(self):
        ...
        with self.assertRaises(ValueError):
            SelectDataSetA("NON_EXISTENT_LABEL", config_file=str(self.config_file_path))
    ...
    def test_default_output_file_name(self):
        """Ensure output file name is set correctly."""
        ds = SelectDataSetA("NRT_BO_002", config_file=str(self.config_file_path))
        self.assertEqual(
