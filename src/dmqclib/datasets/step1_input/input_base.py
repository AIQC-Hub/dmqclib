...
class InputDataSetBase(DataSetBase):
    ...
    def __init__(self, dataset_name: str, config:DataSetConfig):
        ...
        self.input_file_name = self.config.get_full_file_name("input", default_file_name=self.config.data["input_file_name"],
    ...
    def read_input_data(self):
        ...
        read_file_options = self.config.get_step_params("input").get("read_file_options", {})
